/* V2P2E5R03A2 standalone loader: unique filename avoids stale v45.js deployment/cache ambiguity. */
(function(){
  ...
  if(c && typeof c.evaluateFoodShortage==='function' && c.foodShortageRule && typeof window.v2p2e5r03Evaluate==='function'){
    window.__HIVEDASH_V2P2E5R03A2__=true;
    window.__HIVEDASH_V2P2E5R03A2_VERSION__='v2p2e5r03a2-legacy-food-enum-normalization';
    return;
  }
})();

/* ==============================================================
   V2P2E5R03A2 — R03 LEGACY FOOD ENUM NORMALIZATION
   Catalog rule: R03
   Catalog task: S07
   ...
   ============================================================== */
(function v2p2e5r03a2FoodShortageCore(){
  if(window.__HIVEDASH_V2P2E5R03A2__)return;
  window.__HIVEDASH_V2P2E5R03A2__=true;

  const CORE_RULE_ID='HD-R03F-FOOD-SHORTAGE';
  const RULE_VERSION='HD-R03F-v1.0-2026-09-11';
  const MIGRATION_VERSION='V2P2E5R03A2';
