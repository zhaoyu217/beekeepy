/* ==============================================================
   HiveDash V2P2E5R10A7 — R10 / S21 DAY-28 INCLUSIVE / POST-WINDOW CLOSURE
...
(()=>{
  ...
  window.__HIVEDASH_V2P2E5R10A_VERSION__='v2p2e5r10a7-day28-inclusive-post-window';
  window.__HIVEDASH_V2P2E5R10A7_VERSION__='v2p2e5r10a7-day28-inclusive-post-window';

  const CORE_RULE_ID='HD-R10S-SPLIT-VERIFICATION';
  const RULE_VERSION='HD-R10S-v1.1-2026-09-13';
  ...
  console.log('V2P2E5R10A7 CORE LOADED | day 28 inclusive, day 29+ post-window');
})();
