...
(function v2p2e5r12aRobbingPrevention(){
  ...
  function renderReview(hid,episode){
    ...
    return `<div class="vs v2p2e5r12-page v2p2e5r12-review-page">
      ...
      <section class="vc v2p2e5r12-review-card v2p2e5r12-source-card"><div class="v2p2e5r12-source-icon" aria-hidden="true">i</div><div><b>Why these options</b><p>Penn State and Mississippi State Extension describe dearth-related robbing risk, especially around weaker colonies, exposed honey/syrup, entrance access, and prolonged hive opening. HiveDash does not choose a measure automatically.</p></div></section>
...
/* V2P2E5R12UI1 — visual-only alignment with the locked low-frequency Action design system. */
...
.v2p2e5r12-review-hero{position:relative;display:flex;align-items:flex-start;gap:12px;min-height:88px;padding:14px 14px 13px;border-radius:15px;background:linear-gradient(135deg,#EEF1E7 0%,#F8F6EF 100%);border:1px solid rgba(94,115,80,.11);box-shadow:0 4px 12px rgba(47,59,51,.04);overflow:hidden}
.v2p2e5r12-review-hero::after{content:"";position:absolute;right:-26px;bottom:-42px;width:128px;height:128px;border-radius:50%;background:radial-gradient(circle,rgba(197,146,26,.11) 0%,rgba(197,146,26,0) 68%);pointer-events:none}
...
.v2p2e5r12-evidence-grid{display:grid;grid-template-columns:1fr 1fr;gap:8px}.v2p2e5r12-evidence-item{min-width:0;padding:9px 10px;border-radius:11px;background:#FAFAF7;border:1px solid rgba(47,59,51,.07)}.v2p2e5r12-evidence-item span{display:block;margin-bottom:4px;font-size:9px;line-height:1.2;font-weight:700;color:#7A817B}.v2p2e5r12-evidence-item b{display:block;font-size:11px;line-height:1.3;font-weight:800;color:#334C38;overflow-wrap:anywhere}
.v2p2e5r12-review-page .v2p2e5r12-measures{gap:7px}.v2p2e5r12-review-page .v2p2e5r12-measures label{position:relative;display:grid;grid-template-columns:24px 1fr;align-items:center;gap:10px;min-height:48px;padding:8px 10px;border-radius:11px;border:1px solid rgba(47,59,51,.09);background:#FBFBF8;cursor:pointer;transition:border-color .15s ease,background .15s ease,box-shadow .15s ease}.v2p2e5r12-review-page .v2p2e5r12-measures label:has(input:checked){border-color:rgba(94,115,80,.35);background:#F1F3E9;box-shadow:inset 0 0 0 1px rgba(94,115,80,.05)}.v2p2e5r12-review-page .v2p2e5r12-measures input{position:absolute;opacity:0;pointer-events:none;width:1px;height:1px}.v2p2e5r12-check-ui{width:22px;height:22px;border-radius:7px;border:1.5px solid rgba(94,115,80,.34);background:#fff;display:grid;place-items:center;box-sizing:border-box;transition:.15s ease}.v2p2e5r12-check-ui::after{content:"✓";font-size:13px;line-height:1;font-weight:900;color:#fff;opacity:0;transform:scale(.6);transition:.15s ease}.v2p2e5r12-measures input:checked+.v2p2e5r12-check-ui{background:#5E7350;border-color:#5E7350}.v2p2e5r12-measures input:checked+.v2p2e5r12-check-ui::after{opacity:1;transform:scale(1)}.v2p2e5r12-measure-copy{min-width:0}.v2p2e5r12-measure-copy b{display:block;font-size:11px;line-height:1.32;font-weight:750;color:#334C38}
...
.v2p2e5r12-review-page .v2p2e5r12-source-card{display:grid;grid-template-columns:28px 1fr;gap:10px;align-items:flex-start;background:#FAF8F1}.v2p2e5r12-source-icon{width:26px;height:26px;border-radius:9px;display:grid;place-items:center;background:#EEF1E4;color:#5E7350;font-size:12px;font-weight:900}.v2p2e5r12-source-card b{display:block;margin:1px 0 4px;font-size:11.5px;font-weight:850;color:#2F3B33}.v2p2e5r12-source-card p{margin:0;font-size:9.5px;line-height:1.45;font-weight:600;color:#6F776F}
.v2p2e5r12-review-actions{position:sticky;bottom:0;z-index:4;margin:2px -1px 0;padding:10px 1px calc(7px + env(safe-area-inset-bottom));background:linear-gradient(to bottom,rgba(247,245,239,0),rgba(247,245,239,.92) 28%,#F7F5EF 62%);grid-template-columns:.9fr 1.45fr;gap:8px}.v2p2e5r12-review-actions .secondary,.v2p2e5r12-review-actions .primary{min-height:46px;border-radius:11px;font-size:12px;font-weight:800}.v2p2e5r12-review-actions .primary{background:#C5921A!important;color:#fff!important;box-shadow:0 6px 14px rgba(197,146,26,.16)!important}.v2p2e5r12-review-actions .secondary{background:#fff;color:#5E7350;border:1px solid rgba(94,115,80,.18)}
